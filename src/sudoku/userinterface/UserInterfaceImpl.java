...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private final static double WINDOW_X = 668;
    ...
    private final static Color WINDOW_BACKGROUND_COLOR = Color.rgb(0, 150, 136);
    private final static Color BOARD_BACKGROUND_COLOR = Color.rgb(224, 242, 241);
